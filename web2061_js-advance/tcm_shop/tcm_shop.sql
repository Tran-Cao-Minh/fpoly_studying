...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2022 at 02:01 AM
...
INSERT INTO `product_category` (`PkProductCategory_Id`, `CategoryName`, `CategoryOrder`, `CategoryDisplay`) VALUES
(1, 'History', 1, 1),
(2, 'Business', 2, 1),
(3, 'Travel', 3, 1),
(4, 'Technology', 4, 0),
...
CREATE TABLE `product_tag` (
  `PkProductTag_Id` int(11) NOT NULL,
...
--
ALTER TABLE `product_tag`
  MODIFY `PkProductTag_Id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `FkCategory_Id` FOREIGN KEY (`FkCategory_Id`) REFERENCES `product_category` (`PkProductCategory_Id`) ON UPDATE CASCADE;
COMMIT;
