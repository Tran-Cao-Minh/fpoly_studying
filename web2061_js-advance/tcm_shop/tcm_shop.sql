...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 25, 2022 lúc 01:53 PM
...
CREATE TABLE `banner` (
  `PkBanner_Id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `display_status`
--
...
--
-- Đang đổ dữ liệu cho bảng `display_status`
--
...
CREATE TABLE `order` (
  `yourColumnName1` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `order_delivery` (
  `PkOrderDelivery_Id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `order_discount` (
  `PkOrderDiscount_Id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `order_payment` (
  `PkOrderPayment_Id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `order_person`
--

CREATE TABLE `order_person` (
  `PersonName` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `order_status` (
  `PkOrderStatus_Id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `product` (
  ...
  `FkProductTag_Id` tinyint(2) NOT NULL,
  `FkDisplayStatus_Id` tinyint(1) NOT NULL,
  `ProductPrice` double NOT NULL,
  `ProductSalePercent` tinyint(3) NOT NULL,
  `ProductQuantity` int(11) NOT NULL,
  `ProductOrder` tinyint(2) NOT NULL,
...
CREATE TABLE `product_tag` (
  `PkProductTag_Id` tinyint(2) NOT NULL,
  `TagName` varchar(200) NOT NULL,
  `TagImage` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `product_tag` (`PkProductTag_Id`, `TagName`, `TagImage`) VALUES
(0, 'None', ''),
(1, 'New', 'new.svg'),
(2, 'Hot', 'hot.svg');
...
(9, 'Tran Cao Minh', 'minhtc', '$2b$10$VGxha02sZ/OQMxEuYK6IK./k1WswShBbmdzhddA602Drnu5pgQdbi', 'minhtcps18817@fpt.edu.vn', 1, 'Ho Chi Minh - Viet Nam', 0, 1, 'tran-cao-minh_1645146485492.jpeg'),
...
--
-- Chỉ mục cho bảng `display_status`
--
...
ALTER TABLE `product`
  ...
  ADD KEY `FkProductTag_Id` (`FkProductTag_Id`),
  ADD KEY `FkProductDisplayStatus_Id` (`FkDisplayStatus_Id`);
...
ALTER TABLE `product_category`
  ...
  ADD KEY `FkCategoryDisplayStatus_Id` (`FkDisplayStatus_Id`);

--
-- Chỉ mục cho bảng `product_tag`
--
ALTER TABLE `product_tag`
  ADD PRIMARY KEY (`PkProductTag_Id`);
...
--
ALTER TABLE `product`
  MODIFY `PkProduct_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT cho bảng `product_tag`
--
ALTER TABLE `product_tag`
  MODIFY `PkProductTag_Id` tinyint(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `FkProductCategory_Id` FOREIGN KEY (`FkProductCategory_Id`) REFERENCES `product_category` (`PkProductCategory_Id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FkProductDisplayStatus_Id` FOREIGN KEY (`FkDisplayStatus_Id`) REFERENCES `display_status` (`PkDisplayStatus_Id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FkProductTag_Id` FOREIGN KEY (`FkProductTag_Id`) REFERENCES `product_tag` (`PkProductTag_Id`) ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `product_category`
--
ALTER TABLE `product_category`
  ADD CONSTRAINT `FkCategoryDisplayStatus_Id` FOREIGN KEY (`FkDisplayStatus_Id`) REFERENCES `display_status` (`PkDisplayStatus_Id`) ON UPDATE CASCADE;
