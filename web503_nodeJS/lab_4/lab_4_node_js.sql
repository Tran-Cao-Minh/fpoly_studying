...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 19, 2022 lúc 06:04 AM
...
INSERT INTO `product` (`PkProduct_Id`, `ProductName`, `ProductDescription`, `ProductImage`, `ProductUpdate`, `ProductPrice`, `FkCategory_Id`, `ProductDisplay`) VALUES
(1, 'One Piece Pirate Recipes', 'Living the life of a pirate requires hearty meals! The master chef Sanji reveals the recipes that power the Straw Hat crew!\r\nYou can\'t become King of the Pirates on an empty stomach! Monkey D. Luffy has defeated dozens of rivals, and that kind of success takes a whole lot of energy! Fortunately, the pirate cook Sanji stands by Luffy\'s side, ready to support his captain with flaming kicks and piping-hot meals! Hearty and filling, Sanji\'s recipes keep the greatest pirate crew in the world well-fed, and his flashy techniques will take your culinary skills to the next level!', 'one-piece-pirate-recipes_1641985540344.webp', '2022-01-17 00:59:21', 18.38, 5, 0),
...
(9, 'Circe', 'A bold and subversive retelling of the goddess\'s story, this #1 New York Times bestseller is both epic and intimate in its scope, recasting the most infamous female figure from the Odyssey as a hero in her own right (Alexandra Alter, The New York Times).\r\nIn the house of Helios, god of the sun and mightiest of the Titans, a daughter is born. But Circe is a strange child -- not powerful, like her father, nor viciously alluring like her mother. Turning to the world of mortals for companionship, she discovers that she does possess power -- the power of witchcraft, which can transform rivals into monsters and menace the gods themselves.', 'circe_1642126619929.webp', '2022-01-14 02:16:59', 15.62, 1, 1),
(10, 'The Song of Achilles', '\"At once a scholar\'s homage to The Iliad and startlingly original work of art....A book I could not put down.\" --Ann Patchett, author of The Dutch House\r\n\r\nA thrilling, profoundly moving, and utterly unique retelling of the legend of Achilles and the Trojan War from the bestselling author of Circe\r\n\r\nA tale of gods, kings, immortal fame, and the human heart, The Song of Achilles is a dazzling literary feat that brilliantly reimagines Homer\'s enduring masterwork, The Iliad. An action-packed adventure, an epic love story, a marvelously conceived and executed page-turner, Miller\'s monumental debut novel has already earned resounding acclaim from some of contemporary fiction\'s brightest lights--and fans of Mary Renault, Bernard Cornwell, Steven Pressfield, and Colleen McCullough\'s Masters of Rome series will delight in this unforgettable journey back to ancient Greece in the Age of Heroes.', 'the-song-of-achilles_1642126693228.jpeg', '2022-01-14 02:18:13', 15.78, 1, 1);
...
--
ALTER TABLE `product`
  MODIFY `PkProduct_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `product_category`
--
ALTER TABLE `product_category`
  MODIFY `PkCategory_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
