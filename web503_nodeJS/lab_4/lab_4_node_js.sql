...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2022 at 02:22 AM
...
CREATE TABLE `product_category` (
  `PkCategory_Id` int(11) NOT NULL,
  `CategoryName` varchar(200) NOT NULL,
  `CategoryOrder` int(11) NOT NULL,
  `CategoryDisplay` tinyint(1) NOT NULL COMMENT '0: hide / 1: show'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `product_category` (`PkCategory_Id`, `CategoryName`, `CategoryOrder`, `CategoryDisplay`) VALUES
(1, 'History', 1, 1),
(2, 'Business', 2, 1),
(3, 'Travel', 3, 1),
(4, 'Technology', 4, 0),
...
ALTER TABLE `product`
  ...
  ADD KEY `FkType_Id` (`FkCategory_Id`);

--
-- Indexes for table `product_category`
--
ALTER TABLE `product_category`
  ADD PRIMARY KEY (`PkCategory_Id`);
...
--
ALTER TABLE `product`
  MODIFY `PkProduct_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `product_category`
--
ALTER TABLE `product_category`
  MODIFY `PkCategory_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `FkCategory_Id` FOREIGN KEY (`FkCategory_Id`) REFERENCES `product_category` (`PkCategory_Id`) ON UPDATE CASCADE;
COMMIT;
