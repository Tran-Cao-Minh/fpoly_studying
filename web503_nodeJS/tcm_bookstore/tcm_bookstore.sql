...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2022 at 05:53 AM
...
INSERT INTO `product` (`PkProduct_Id`, `ProductName`, `ProductDescription`, `ProductImage`, `ProductUpdate`, `ProductPrice`, `FkType_Id`, `ProductDisplay`, `ProductPublisher`, `ProductPublishDate`, `ProductDimensions`, `ProductPages`, `ProductViews`) VALUES
...
(19, 'One Piece Pirate Recipes', 'Living the life of a pirate requires hearty meals! The master chef Sanji reveals the recipes that power the Straw Hat crew!\r\nYou can\'t become King of the Pirates on an empty stomach! Monkey D. Luffy has defeated dozens of rivals, and that kind of success takes a whole lot of energy! Fortunately, the pirate cook Sanji stands by Luffy\'s side, ready to support his captain with flaming kicks and piping-hot meals! Hearty and filling, Sanji\'s recipes keep the greatest pirate crew in the world well-fed, and his flashy techniques will take your culinary skills to the next level!', 'one-piece-pirate-recipes_1642264267092.webp', '2022-01-16 04:08:08', 18.38, 5, 1, 'Viz Media', '2021-11-23', '7.3 X 10.3 X 0.5 inches | 1.1 pounds', 96, 14),
